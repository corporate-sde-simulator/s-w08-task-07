...
> **Welcome to Service-Track Week 8, Task 7!**
...
| `src/releaseNotesGenerator.py` | Main source code - **has bugs to fix** |
| `src/versionManager.py` | Supporting code - **may also have bugs** |
| `tests/releaseNotesGenerator.test.ts` | Test file - **add your tests here** |
